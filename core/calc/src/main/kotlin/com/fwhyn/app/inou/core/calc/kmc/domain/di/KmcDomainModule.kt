package com.fwhyn.app.inou.core.calc.kmc.domain.di

import com.fwhyn.app.inou.core.calc.kmc.domain.usecase.ExportKmcListUseCase
import com.fwhyn.app.inou.core.calc.kmc.domain.usecase.ExportKmcListUseCaseReal
import com.fwhyn.app.inou.core.calc.kmc.domain.usecase.GenerateKmcListExcelUseCase
import com.fwhyn.app.inou.core.calc.kmc.domain.usecase.GenerateKmcListExcelUseCaseReal
import com.fwhyn.app.inou.core.calc.kmc.domain.usecase.GetKmcListUseCase
import com.fwhyn.app.inou.core.calc.kmc.domain.usecase.GetKmcListUseCaseReal
import dagger.Binds
